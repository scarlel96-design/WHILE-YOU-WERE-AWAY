...
public final class NpcExceptionArchiveProbe {
 public static void main(String[] args)throws Exception {
  ...
  try(var jar=new JarFile(args[0])) {
   ...
   if(npc.contains("hasWitness")!=expected||!data.contains("STORY_WRITE_BLOCKED")||jar.getEntry("io/github/whileaway/CanonicalRecovery.class")==null)throw new AssertionError("artifact contract");
   System.out.println("PASS archive="+args[1]+" canonicalRecovery=true writeGuard=true campaignNpc=true witnessGate="+expected);
  }
 }
}
