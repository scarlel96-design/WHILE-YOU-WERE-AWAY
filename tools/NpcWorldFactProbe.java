...
public final class NpcWorldFactProbe {
    ...
    public static void main(String[] args)throws Exception {
        ...
        for(var root:List.of(preparing,complete)) {
            add(actor(root),NpcState.relationship("npc:doyun","shared_repair"));
            ...
            check(again.facts.contains(NpcState.relationship("npc:doyun","shared_repair")),"NPC to NPC relationship lost");
        ...
        System.out.println("PASS NPC storage cases="+cases+" semanticBlocked=6 normalRoundTrips=2 npcCounterpartRoundTrips=2 originalsPreserved=true actualClient=false");System.exit(0);
    }
}
